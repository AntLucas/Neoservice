                            ...
                            <div class="row register-form">
                                ...
                                <div class="col-md-6">
                                    <form method="get" action=".">
                                        <input name="cep" type="text" id="cep" value="" required="required" size="10" maxlength="9" class="form-control" placeholder="CEP *" onblur="pesquisacep(this.value);" />
                                        <p />
                                        <p>
                                            <input name="rua" type="text" id="rua" readonly="true" size="60" class="form-control" placeholder="Rua *" />
                                            <p />
                                            <input name="bairro" type="text" id="bairro" readonly="true" size="40" class="form-control" placeholder="Bairro *" />
                                            <p />
                                            <input name="cidade" type="text" id="cidade" readonly="true" size="40" class="form-control" placeholder="Cidade *" />
                                            <p />
                                            <input name="uf" type="text" id="uf" readonly="true" size="2" class="form-control" placeholder="Estado *" />
                                            <p />
                                    </form>
...
if ($_POST['env'] && $_POST['env'] == "Registrar") {
    if ($_POST['nmUsu'] || $_POST['nmEsb'] || $_POST['email'] || $_POST['senha'] || $_POST['senha2'] || $_POST['bday'] || $_POST['cep'] || $_POST['rua'] || $_POST['bairro'] || $_POST['cidade'] || $_POST['estado']) {
		...
		values('$nmUsu','$senha','$nmEsb','$email','$bday','$cep','$estado','$cidade','$bairro','$rua','Edite esse campo','Edite esse campo','Edite esse campo','Edite esse campo','Sem Profissão','user.jpg');") or die('Error, insert query failed');
