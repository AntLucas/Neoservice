...
on b.IdEmpresa = c.fk_IdEmpresa") or die('Error, insert query failed');
    ...
    <main class="page-content">
        <div class="container-fluid">
            <div class="container"><br>
                <div class="jumbotron p-3 text-center">
                    <h1 class="display-4">Busca de Candidatos</h1>
                    <hr>
		...
		where b.fk_IdCompetencia = '$IdCompetencia'") or die('Error, insert query failed');
                    ...
                    ?>
                            <div class="col-sm-6">
                                <div class="card">
                                    <h4 class="card-header text-right bg-dark text-white"><?php echo utf8_decode("$nmcandidato"); ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><?php echo utf8_decode("$biografia"); ?></p>
                                    </div>
                                </div>
                            </div>
                    <?php
